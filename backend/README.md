...
data: {"type":"text","content":"## 1. 보호구 착용 여부\n- 안전모:"}
data: {"type":"text","content":" 미착용 (×위반)\n\n## 2. 난간"}
data: {"type":"text","content":"대 높이\n- 현황: 85cm\n- 기준: 90cm"}
```
...
|------|-----------------|-----------------|
| 네트워크 요청 수 | 800+ | 15~20 |
| 평균 응답 크기 | 2~5 bytes | 50~60 bytes |
| 프론트엔드 부담 | 높음 | 낮음 |
| UX | 끊김 현상 | 부드러운 스트림 |
...
더 자세한 내용은 **[STREAMING_GUIDE.md](./STREAMING_GUIDE.md)** 참고
